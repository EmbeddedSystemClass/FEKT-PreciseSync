...
#define configIP_ADDR1		2
#define configIP_ADDR2		222
#define configIP_ADDR3		46

/* Default gateway IP address configuration.  Used in ipconfigUSE_DNS is set to
0, or ipconfigUSE_DNS is set to 1 but a DNS server cannot be contacted. */
#define configGATEWAY_ADDR0	10
#define configGATEWAY_ADDR1	2
...
#define configDNS_SERVER_ADDR0 193
#define configDNS_SERVER_ADDR1 225
#define configDNS_SERVER_ADDR2 151
#define configDNS_SERVER_ADDR3 143
...
#define ipconfigIP_TASK_PRIORITY			( (configMAX_PRIORITIES - 5)  | portPRIVILEGE_BIT)
...
#define ipconfigETHERNET_DRIVER_RX_TASK_BLOCK_TIME 			100	/* Ticks */
...
/* EMAC_TX block time */
#define ipconfigETHERNET_DRIVER_TX_BLOCK_TIME			2
...
/* FLow controll related defines */
#define ipconfigETHERNET_DRIVER_RX_FLOW_CONTROLL	(1)
#define ipconfigRX_FLOWCONTROL_START_LEVEL 			(5)
...
#define configHTTP_ROOT 					"/ram/web"
